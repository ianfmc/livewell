...
**Timing Annotation status:** Spec approved — pending implementation
- Add `timing_slot` and `timing_risk` informational columns to signal pipeline output
- Nearest-preceding-slot lookup from asset-class timing tables (`docs/nadex_timing_tables.md`)
- 4 new tests; no changes to `signal_valid` logic
- Implementation plan: `docs/superpowers/plans/2026-04-30-timing-annotation.md` (pending)
